...
class TestMainApp:
    ...
    def mock_components(self):
        ...
        with patch.object(main_module, "db_manager", mock_db), patch.object(
            main_module, "embedding_generator", mock_emb
        ), patch.object(main_module, "rag_pipeline", mock_rag):
    ...
    def test_root_endpoint_with_error(self, client):
        ...
        with patch.object(main_module, "db_manager", mock_db):
            response = client.get("/")
